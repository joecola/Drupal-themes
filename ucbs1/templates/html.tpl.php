...
<head>
  ...
  <?php print $head; ?>
  <title><?php //print $head_title; ?>UChicago Class Challenge</title>
  <?php print $styles; ?>
  ...
  <link type="text/css" rel="stylesheet" href="/sites/all/themes/ucbs1/css/theme.css" media="all" />
    <script src="/sites/all/themes/ucbs1/js/script1.js"></script>


    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-56658849-4"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-56658849-4');
