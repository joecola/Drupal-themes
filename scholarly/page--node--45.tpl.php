...
<header id="header"  role="banner" class="clearfix">
    <div class="container">
        <div class="mobile-reg"><a class="mobile-reg-link" href="https://giving.uchicago.edu/site/Donation2?df_id=1681&mfc_pref=T&1681.donation=form1&set.DesignationType=1001&set.Designee=1527">MAKE&nbsp;A&nbsp;GIFT</a></div>
        <!-- #header-inside -->
    ...
    <div class="container">
        ...
        <div id="banner-inside" class="clearfix">
            <div class="row">
                ...
                <div class="banner-area"><div class="floater"><?php include 'floater.php'; ?></div>
                ...
                <section class="<?php print $main_grid_class; ?>">
                    ...
                    <div id="main" class="clearfix">
                        ...
                        <div class="socialbuttons">
                          ...
                          <a class="btn" href="/look-whos-coming">Look Who's Coming</a>
                          <a class="btn" href="/class-dinners">Class Dinners</a>
                        -->
                          <a class="btn" href="/photos">Photos</a>
                          <a class="btn" href="https://alumniweekend.uchicago.edu/reunions#lab">Milestone&nbsp;Reunions</a>
                        </div>
