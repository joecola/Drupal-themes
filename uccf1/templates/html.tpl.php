...
<head>
  ...
  <?php print $head; ?>
  <title><?php //print $head_title; ?>UChicago Crowdfunding</title>
  <?php print $styles; ?>
  ...
  <link type="text/css" rel="stylesheet" href="/sites/all/themes/uccf1/css/theme.css" media="all" />
    <script src="/sites/all/themes/uccf1/js/script1.js"></script>
</head>
